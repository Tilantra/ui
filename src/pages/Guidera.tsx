                    ...
                    <div className="container mx-auto px-6 relative z-10">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                            ...
                            >
                                ...
                                <p className="text-xl md:text-2xl text-slate-600 dark:text-white/80 leading-relaxed mb-10 max-w-xl">
                                ...
                                <div className="flex flex-wrap gap-4 mb-12">
                                    <Link
                                        ...
                                        className="px-8 py-4 rounded-full bg-slate-900 dark:bg-white text-white dark:text-blue-900 font-bold text-lg shadow-lg hover:shadow-xl hover:scale-105 transition-all flex items-center gap-2 group"
                                    >
                                    ...
                                    <AnimatePresence mode="wait">
                                        {hoveredIndex !== null && (
                                            <motion.p
                                                ...
                                                className="text-blue-600 dark:text-blue-300 text-lg font-medium leading-relaxed max-w-lg border-l-2 border-blue-500/30 dark:border-blue-400/30 pl-6 italic"
                                            >
                                        ...
                                        return (
                                            ...
                                            >
                                                <div className={cn(
                                                    ...
                                                    />
                                                    {!isHovered && (
                                                        <div className="absolute inset-0 bg-white/20 dark:bg-slate-900/5 backdrop-blur-[0.5px] hover:backdrop-blur-0 transition-all" />
                                                    )}
                                                </div>
                                            </motion.div>
                                        );
