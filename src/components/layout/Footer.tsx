            ...
            <div className="container mx-auto px-6 py-14">
                ...
                <div className="mt-12 pt-8 border-t border-slate-200 dark:border-white/[0.05] flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <div className="flex items-center gap-5">
                        {/* X / Twitter */}
                        <a href="#" aria-label="X" className="text-slate-500 dark:text-white/20 hover:text-blue-500 dark:hover:text-white/60 transition-colors">
                            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                            </svg>
                        </a>
                        {/* GitHub */}
                        <a href="#" aria-label="GitHub" className="text-slate-500 dark:text-white/20 hover:text-blue-500 dark:hover:text-white/60 transition-colors">
                            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        {/* LinkedIn */}
                        <a href="#" aria-label="LinkedIn" className="text-slate-500 dark:text-white/20 hover:text-blue-500 dark:hover:text-white/60 transition-colors">
                            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
